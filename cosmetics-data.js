...
export const WORLDS=[
 ...
 {id:'harbor',name:'Puerto al atardecer',rarity:'rare',sky:'#efb89e',icon:'⚓'},
 {id:'aurora-world',name:'Aurora boreal',rarity:'epic',sky:'#182e47',icon:'🌌'},
 {id:'festival',name:'Festival UPI',rarity:'legendary',sky:'#49335e',icon:'🎏'},
 {id:'sky-city',name:'Metrópolis galáctica',rarity:'legendary',sky:'#100d2b',icon:'🌃'}
];
export const CATALOG=[
 ...WORLDS.map(w=>({...w,slot:'world'})),
 {id:'luna-sakura',name:'Luna · Sakura',slot:'character',asset:'female-a',color:'#f3b8d7',rarity:'rare',icon:'🌸'},
 {id:'sam-survivor',name:'Sam · Superviviente',slot:'character',asset:'survivor-male',rarity:'rare',icon:'🧭'},
 {id:'zoe-survivor',name:'Zoe · Superviviente',slot:'character',asset:'survivor-female',rarity:'epic',icon:'🎒'},
 ...
 {id:'spark-visor',name:'Visor de chispas',slot:'face',asset:'spark-visor',rarity:'rare',icon:'✨'},
 {id:'orbit-crown',name:'Corona orbital',slot:'head',asset:'orbit-crown',rarity:'epic',icon:'🪐'},
 {id:'frog-hat',name:'Gorro rana',slot:'head',asset:'frog-hat',rarity:'rare',icon:'🐸'},
 {id:'pizza-hat',name:'Pizza suprema',slot:'head',asset:'pizza-hat',rarity:'epic',icon:'🍕'},
 {id:'cat-beanie',name:'Beanie felino',slot:'head',asset:'cat-beanie',rarity:'legendary',icon:'🐱'},
 {id:'pixel-glasses',name:'Lentes pixel',slot:'face',asset:'pixel-glasses',rarity:'rare',icon:'👾'},
 {id:'party-glasses',name:'Lentes fiesta',slot:'face',asset:'party-glasses',rarity:'epic',icon:'🎉'},
 {id:'ski-goggles',name:'Antiparras ski',slot:'face',asset:'ski-goggles',rarity:'legendary',icon:'🥽'},
